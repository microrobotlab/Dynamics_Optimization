...
Nt = 10000; Np = 500; L = 100.; R = 1.5; v = 10.
...
N = 4; M = 4; x_min = -L/2 - ϵ; x_max = L/2 + ϵ; y_min = -L/2 - ϵ; y_max = L/2 + ϵ


# FLAMGRAPH
ProfileView.@profview run((Nt=Nt,Np=Np,L=L,R=R,v=v); wall_condition=wall_condition, animate=animate, animation_stride=animation_stride, N=N, M=M);
